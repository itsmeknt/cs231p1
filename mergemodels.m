...
for m = 2:length(models)
  ...
  for i = 1:models{m}.numcomponents
    ...
    model.components{nc+i}.rootidx = ...
        models{m}.components{i}.rootidx + nr;    
    for j = 1:length(model.components{nc+i}.parts)
      ...
      model.components{nc+i}.parts{j}.partidx = ...
          model.components{nc+i}.parts{j}.partidx + np;
      model.components{nc+i}.parts{j}.defindex = ...
          model.components{nc+i}.parts{j}.defindex + nd;
      model.components{nc+i}.parts{j}.defidx = ...
          model.components{nc+i}.parts{j}.defidx + nd;
    end
  end
